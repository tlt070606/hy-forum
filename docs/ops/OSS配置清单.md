...
| # | 值 | 例子 |
|---|---|---|
| 1 | **Bucket 名** | `hy-forum-img-abc` |
| 2 | **地域 / Endpoint** | 华东1（杭州）→ `oss-cn-hangzhou.aliyuncs.com` |
| 3 | **回调公网地址** | `http://8.138.237.212:18080/api/oss/callback` |

> **不要给我 AccessKey。** 它只在你本机的环境变量或 `web/.env.local` / `application-local.yml` 里。
