 ...
 *
 * **全部为真数据**（2026-09-18 需求方裁定：假数据一律换成有后端接口的）：
 * - 右栏：版块榜（/api/boards）/ 最新发帖的人（/api/posts 的作者去重）
 * - 左栏：帖子总数；顶栏：未读通知数（/api/notifications/unread-count）
 * - **src/mock/ 目录已整体删除** —— 前端不再有任何编造的数据
 *
 * **未交付并明确提示**（不做假成功）：
